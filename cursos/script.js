...
document.addEventListener('DOMContentLoaded', function () {
    const cursos = [
        ...
        { codigogoogle: ["Engenharia Elétrica"], nome: "Engenharia Elétrica", semestres: "10 semestres", horariodianoite: ["Noturno -"], tipodegraduacao: ["Bacharelado"], tags: ["graduação", "exatas", "informática"], descricao: "Descrição do curso de Engenharia Elétrica.", link: "link-engenharia-eletrica.html" },
        ...
        { codigogoogle: ["Pós EstraFiscal"], nome: "Estratégia Fiscal e Tributária", semestres: "Aulas semanais - 18 Meses", horariodianoite: ["Noturno -"], tipodegraduacao: ["Bacharelado"], tags: ["pós-graduação", "exatas"], descricao: "Descrição do curso de Pós EstraFiscal.", link: "https://info.fam.br/cursos/estrategia-fiscal/" },
        ...
        { codigogoogle: ["Pós MBAFinanças"], nome: "MBA em Finanças, Investiment e Banking", semestres: "Aulas quizenais - 18 meses", horariodianoite: ["Noturno -"], tipodegraduacao: ["Bacharelado"], tags: ["pós-graduação", "exatas"], descricao: "Descrição do curso de Pós MBAFinanças.", link: "https://info.fam.br/cursos/mba-financas/" },
        ...
        { codigogoogle: ["Pós Marketing"], nome: "Marketing e Negócios",  semestres: "Aulas quinzenais ou semanais - 18 meses", horariodianoite: ["Noturno -"], tipodegraduacao: ["Bacharelado"], tags: ["pós-graduação", "humanas", "criatividade"], descricao: "Descrição do curso de Pós Marketing.", link: "https://info.fam.br/cursos/marketing-e-negocios/" },
        { codigogoogle: ["Pós Equina"], nome: "Medicina Equina", semestres: "20 horas de aula /mês - 20 meses", horariodianoite: ["Noturno -"], tipodegraduacao: ["Bacharelado"], tags: ["pós-graduação", "saúde", "animais"], descricao: "Descrição do curso de Pós Equina.", link: "https://info.fam.br/cursos/medicina-equina/" },
        ...
        { codigogoogle: ["Pós Neuro"], nome: "Neuropsicopedagogia Clínica e Psicomotricidade", semestres: "Aulas quinzenais - 24 Meses", horariodianoite: ["Noturno -"], tipodegraduacao: ["Bacharelado"], tags: ["pós-graduação", "saúde"], descricao: "Descrição do curso de Pós Neuro.", link: "https://info.fam.br/cursos/neuropsicopedagogia/" },
